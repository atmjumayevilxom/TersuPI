 ...
 */
add_action( 'after_setup_theme', 'study_circle_setup_woocommerce_support' );
function study_circle_setup_woocommerce_support()   
{
 ...
 */
function study_circle_skip_link_focus_fix() {  
...
add_action( 'wp_print_footer_scripts', 'study_circle_skip_link_focus_fix' ); 